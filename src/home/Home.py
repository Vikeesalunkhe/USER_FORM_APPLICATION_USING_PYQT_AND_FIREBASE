...
credentials_path = './setup/userinfo-118c2-firebase-adminsdk-gsnp3-c712a66d2a.json'
...
class C2W_UserProfileForm(QWidget):
    ...
    def c2w_init_ui(self):
        ...
        self.records_layout = QVBoxLayout(self.records_widget) # QVBoxLayout for therecords
    ...
    def c2w_fetch_records(self):
        ...
        for user_profile in user_profiles:
            ...
            if count%2==0:
                record_label.setStyleSheet("background-color: #c3bcbc; border: 1px solidblack; padding: 5px; border-radius:10px")
